    ...
    <div className={styles.page}>
      ...
      <header className={styles.header}>
        <div className={styles.topBar}>
          ...
          <div className={styles.topInfo}>
            <div className={styles.topItem}>
              ...
              <div>
                <strong>FITUP Corporate</strong><br />
                <span>Headquarters: Ho Chi Minh City, Vietnam</span>
              </div>
            </div>
            <div className={styles.topItem}>
              <span className={styles.icon}>✉️</span>
              <span><strong>Email:</strong> hello@fitup.com</span>
            </div>
            <div className={styles.topItem}>
              <span className={styles.icon}>☎️</span>
              <span><strong>Telephone:</strong> 0987654321</span>
            </div>
          </div>
        </div>
        ...
        <nav className={styles.navBar}>
          ...
          <Link className={styles.navLinkActive} href="/aboutus">About us</Link>
      ...
      <main className={styles.mainContent}>
        <section className={styles.hero}>
          ...
          <p className={`${styles.heroSubtitle} ${styles.heroQuote}`}>
            FitUp, your ultimate fitness companion, the one stop shop for all your fitness needs.
          </p>
        </section>
        ...
        <section className={styles.mission}>
          ...
          <p className={styles.missionText}>
            An application that combines workout tracking, flexible exercises, and trusted fitness knowledge to help you train better. We study modern training methods and work with experienced coaches to create fun and motivating challenges that keep you improving.
            Help you build simple meal plans that help you reach your goals while still enjoying your food.
          </p>
          <div className={`${styles.heroImagePlaceholder} ${styles.placeholderImageBox}`}>Placeholder image</div>
        </section>

        <section className={styles.mission}>
          <h2 className={styles.heroTitle}>Our Vision</h2>
          <p className={styles.missionText}>
            To become the most trusted digital fitness ecosystem in Vietnam and beyond, where everyone can access smart training,
            practical nutrition guidance, and professional coaching to build a healthier life.
          </p>
        </section>
      ...
      <footer className={`${styles.footer} ${styles.aboutFooter}`}>
        <div className={`${styles.footerContainer} ${styles.aboutFooterContainer}`}>
          ...
          <div className={styles.footerCompany}>
            ...
            <p><strong>Company Registration Certificate:</strong> 01234567</p>
          </div>
        ...
        <div className={`${styles.footerBottom} ${styles.aboutFooterBottom}`}>
          ...
          <div className={styles.socialIcons}>
            ...
            <svg className={styles.icon} width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <mask id="ytmask" mask-type="luminance" maskUnits="userSpaceOnUse" x="0" y="1" width="12" height="10">
